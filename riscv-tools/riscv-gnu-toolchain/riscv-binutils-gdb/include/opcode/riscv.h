...
// LACore extension registers
extern const char * const riscv_la_core_names_numeric[NLREG];
extern const char * const riscv_la_core_names_abi[NLREG];

// LACore extension mem location values (register, main memory or scratchpad)
#define LA_LOC_REG        0x0
#define LA_LOC_MEM        0x1
#define LA_LOC_SCH        0x2

// LACore fields
#define OP_MASK_LOP       0x3
#define OP_SH_LOP         7
#define OP_MASK_LFUNC3    0x7
#define OP_SH_LFUNC3      9
#define OP_MASK_LFUNC2    0x3
#define OP_SH_LFUNC2      15
#define OP_MASK_MST       0x1
#define OP_SH_MST         17
#define OP_MASK_LZERO9    0x1ff
#define OP_SH_LZERO9      15

#define OP_MASK_LRD       0x7
#define OP_SH_LRD         12
#define OP_MASK_LRC       0x7
#define OP_SH_LRC         18
#define OP_MASK_LRB       0x7
#define OP_SH_LRB         21
#define OP_MASK_LRA       0x7
#define OP_SH_LRA         24

#define OP_MASK_LRXC      0x1f
#define OP_SH_LRXC        17
#define OP_MASK_LRXB      0x1f
#define OP_SH_LRXB        22
#define OP_MASK_LRXA      0x1f
#define OP_SH_LRXA        27
#define OP_MASK_LRFA      0x1f
#define OP_SH_LRFA        27

// LACore extension pseudo fields
#define OP_MASK_L_T2      0x1
#define OP_SH_L_T2        9
#define OP_MASK_L_SU      0x1
#define OP_SH_L_SU        10
#define OP_MASK_L_DV      0x1
#define OP_SH_L_DV        11
#define OP_MASK_L_RDCT    0x3
#define OP_SH_L_RDCT      15

#define OP_MASK_L_ALT     0x1
#define OP_SH_L_ALT       9
#define OP_MASK_L_VOUT    0x1
#define OP_SH_L_VOUT      10
#define OP_MASK_L_DP      0x1
#define OP_SH_L_DP        11
#define OP_MASK_L_TNS     0x1
#define OP_SH_L_TNS       15
#define OP_MASK_L_SPV     0x1
#define OP_SH_L_SPV       16
#define OP_MASK_LRDLOC    0x3
#define OP_SH_LRDLOC      15
