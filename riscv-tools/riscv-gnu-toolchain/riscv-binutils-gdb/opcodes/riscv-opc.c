...
// LACore extension registers
const char * const riscv_la_core_names_numeric[NLREG] = {
  "lr0",  "lr1",  "lr2",  "lr3",  "lr4",  "lr5",  "lr6",  "lr7"
};

// LACore extension registers
const char * const riscv_la_core_names_abi[NLREG] = {
  "lar0", "lar1", "lar2", "lar3", "lar4", "lar5", "lar6", "lar7"
};

//=============================================================================
// End RISC-V LACore Extension
//=============================================================================
...
{
  //printf("DEBUG: insn=%#u match=%#u mask=%#u\n", insn, op->match, op->mask);
...
//DATA OPS
{"ldrmabn",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMABN,  MASK_LDRMABN,  match_opcode, 0 },
{"ldrmabx",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMABX,  MASK_LDRMABX,  match_opcode, 0 },
{"ldrmabs",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMABS,  MASK_LDRMABS,  match_opcode, 0 },
{"ldrmatn",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMATN,  MASK_LDRMATN,  match_opcode, 0 },
{"ldrmatx",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMATX,  MASK_LDRMATX,  match_opcode, 0 },
{"ldrmats",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMATS,  MASK_LDRMATS,  match_opcode, 0 },
{"ldrmsbn",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMSBN,  MASK_LDRMSBN,  match_opcode, 0 },
{"ldrmsbx",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMSBX,  MASK_LDRMSBX,  match_opcode, 0 },
{"ldrmsbs",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMSBS,  MASK_LDRMSBS,  match_opcode, 0 },
{"ldrmstn",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMSTN,  MASK_LDRMSTN,  match_opcode, 0 },
{"ldrmstx",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMSTX,  MASK_LDRMSTX,  match_opcode, 0 },
{"ldrmsts",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMSTS,  MASK_LDRMSTS,  match_opcode, 0 },
{"ldrdabn",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDABN,  MASK_LDRDABN,  match_opcode, 0 },
{"ldrdabx",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDABX,  MASK_LDRDABX,  match_opcode, 0 },
{"ldrdabs",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDABS,  MASK_LDRDABS,  match_opcode, 0 },
{"ldrdatn",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDATN,  MASK_LDRDATN,  match_opcode, 0 },
{"ldrdatx",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDATX,  MASK_LDRDATX,  match_opcode, 0 },
{"ldrdats",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDATS,  MASK_LDRDATS,  match_opcode, 0 },
{"ldrdsbn",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDSBN,  MASK_LDRDSBN,  match_opcode, 0 },
{"ldrdsbx",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDSBX,  MASK_LDRDSBX,  match_opcode, 0 },
{"ldrdsbs",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDSBS,  MASK_LDRDSBS,  match_opcode, 0 },
{"ldrdstn",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDSTN,  MASK_LDRDSTN,  match_opcode, 0 },
{"ldrdstx",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDSTX,  MASK_LDRDSTX,  match_opcode, 0 },
{"ldrdsts",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRDSTS,  MASK_LDRDSTS,  match_opcode, 0 },
{"ldrmmabn", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMABN, MASK_LDRMMABN, match_opcode, 0 },
{"ldrmmabx", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMABX, MASK_LDRMMABX, match_opcode, 0 },
{"ldrmmabs", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMABS, MASK_LDRMMABS, match_opcode, 0 },
{"ldrmmatn", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMATN, MASK_LDRMMATN, match_opcode, 0 },
{"ldrmmatx", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMATX, MASK_LDRMMATX, match_opcode, 0 },
{"ldrmmats", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMATS, MASK_LDRMMATS, match_opcode, 0 },
{"ldrmmsbn", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMSBN, MASK_LDRMMSBN, match_opcode, 0 },
{"ldrmmsbx", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMSBX, MASK_LDRMMSBX, match_opcode, 0 },
{"ldrmmsbs", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMSBS, MASK_LDRMMSBS, match_opcode, 0 },
{"ldrmmstn", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMSTN, MASK_LDRMMSTN, match_opcode, 0 },
{"ldrmmstx", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMSTX, MASK_LDRMMSTX, match_opcode, 0 },
{"ldrmmsts", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMMSTS, MASK_LDRMMSTS, match_opcode, 0 },
{"ldrmdabn", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDABN, MASK_LDRMDABN, match_opcode, 0 },
{"ldrmdabx", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDABX, MASK_LDRMDABX, match_opcode, 0 },
{"ldrmdabs", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDABS, MASK_LDRMDABS, match_opcode, 0 },
{"ldrmdatn", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDATN, MASK_LDRMDATN, match_opcode, 0 },
{"ldrmdatx", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDATX, MASK_LDRMDATX, match_opcode, 0 },
{"ldrmdats", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDATS, MASK_LDRMDATS, match_opcode, 0 },
{"ldrmdsbn", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDSBN, MASK_LDRMDSBN, match_opcode, 0 },
{"ldrmdsbx", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDSBX, MASK_LDRMDSBX, match_opcode, 0 },
{"ldrmdsbs", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDSBS, MASK_LDRMDSBS, match_opcode, 0 },
{"ldrmdstn", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDSTN, MASK_LDRMDSTN, match_opcode, 0 },
{"ldrmdstx", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDSTX, MASK_LDRMDSTX, match_opcode, 0 },
{"ldrmdsts", "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDRMDSTS, MASK_LDRMDSTS, match_opcode, 0 },
{"ldvmab",   "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMAB,   MASK_LDVMAB,   match_opcode, 0 },
{"ldvmat",   "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMAT,   MASK_LDVMAT,   match_opcode, 0 },
{"ldvmsb",   "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMSB,   MASK_LDVMSB,   match_opcode, 0 },
{"ldvmst",   "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMST,   MASK_LDVMST,   match_opcode, 0 },
{"ldvdab",   "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVDAB,   MASK_LDVDAB,   match_opcode, 0 },
{"ldvdat",   "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVDAT,   MASK_LDVDAT,   match_opcode, 0 },
{"ldvdsb",   "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVDSB,   MASK_LDVDSB,   match_opcode, 0 },
{"ldvdst",   "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVDST,   MASK_LDVDST,   match_opcode, 0 },
{"ldvmmab",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMMAB,  MASK_LDVMMAB,  match_opcode, 0 },
{"ldvmmat",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMMAT,  MASK_LDVMMAT,  match_opcode, 0 },
{"ldvmmsb",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMMSB,  MASK_LDVMMSB,  match_opcode, 0 },
{"ldvmmst",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMMST,  MASK_LDVMMST,  match_opcode, 0 },
{"ldvmdab",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMDAB,  MASK_LDVMDAB,  match_opcode, 0 },
{"ldvmdat",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMDAT,  MASK_LDVMDAT,  match_opcode, 0 },
{"ldvmdsb",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMDSB,  MASK_LDVMDSB,  match_opcode, 0 },
{"ldvmdst",  "Xlacore", "XD,XA,XB,XC,Xa", MATCH_LDVMDST,  MASK_LDVMDST,  match_opcode, 0 },

//CFG OPS
{"lcfgsxs",   "Xlacore", "XDm,Xa",       MATCH_LCFGSXS,   MASK_LCFGSXS,   match_opcode, 0 },
{"lcfgsxd",   "Xlacore", "XDm,Xa",       MATCH_LCFGSXD,   MASK_LCFGSXD,   match_opcode, 0 },
{"lcfgsfs",   "Xlacore", "XD,Xf",        MATCH_LCFGSFS,   MASK_LCFGSFS,   match_opcode, 0 },
{"lcfgsfd",   "Xlacore", "XD,Xf",        MATCH_LCFGSFD,   MASK_LCFGSFD,   match_opcode, 0 },
{"lcfgvadrv", "Xlacore", "XD,Xa",        MATCH_LCFGVADRV, MASK_LCFGVADRV, match_opcode, 0 },
{"lcfgvadrs", "Xlacore", "XD,Xa,Xb,Xc",  MATCH_LCFGVADRS, MASK_LCFGVADRS, match_opcode, 0 },
{"lcfgvadrt", "Xlacore", "XD,Xa,Xb,Xc",  MATCH_LCFGVADRT, MASK_LCFGVADRT, match_opcode, 0 },
{"lcfgvlays", "Xlacore", "XDm,Xa,Xb,Xc", MATCH_LCFGVLAYS, MASK_LCFGVLAYS, match_opcode, 0 },
{"lcfgvlayd", "Xlacore", "XDm,Xa,Xb,Xc", MATCH_LCFGVLAYD, MASK_LCFGVLAYD, match_opcode, 0 },

//XFER OPS
{"lxferdata",     "Xlacore", "XD,XA,Xa", MATCH_LXFERDATA,     MASK_LXFERDATA,     match_opcode, 0 },
{"lxfercsrget",   "Xlacore", "Xa",       MATCH_LXFERCSRGET,   MASK_LXFERCSRGET,   match_opcode, 0 },
{"lxfercsrclear", "Xlacore", "",         MATCH_LXFERCSRCLEAR, MASK_LXFERCSRCLEAR, match_opcode, 0 },
